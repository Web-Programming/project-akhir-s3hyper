<div class="container">
    ...
    <div class="row">
        <div class="col-md-8 mb-3 text-light-custom">
          <h1>{{$title}}</h1>
        </div>
        @if (!$detail_buku)
            <div class="col-md-4">
    ...
    @if ($detail_buku)
        ...
        <div class="row">
            ...
            <div class="col-md-8 text-light-custom">
                 <table class="table text-light-custom">
                  <tbody>
                    <tr>
                      <th>Judul</th>
                      <td>:</td>
            ...
            <div class="row">
                @foreach ($buku as $item)
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div wire:click="detailBuku({{$item->id}})" class="card card-transparent mb-4" style="cursor: pointer;">
